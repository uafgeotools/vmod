...
class Regsill_Y(Source):
    ...
    ln : 
    """
    def __init__(self, data, typ=None, ln=None,wn=None, xcen=None,ycen=None,depth=None,length=None,width=None,strike=None,dip=None,lamb=None):
    ...
    def set_x0(self, x0):
        self.x0=[x0 for i in range(self.ln*self.wn)]
    
    def set_bounds(self,low_bound,high_bound):
        self.get_parnames()
        self.low_bounds=[low_bound for i in range(self.ln*self.wn)]
        self.high_bounds=[high_bound for i in range(self.ln*self.wn)]
